...
In total, there are `r nrow(amyloid)` participants recruited in this study, and `r nrow(amyloid_clean)` participants meet the inclusion criteria. The variables evaluated are `r names (amyloid_clean)`.
...
After cleaning, there are `r nrow(combined_clean)` participatns appears in both dataset and satisfied all inclusion criteria. The variables considered in this dataset are `r names(combined_clean)`.
